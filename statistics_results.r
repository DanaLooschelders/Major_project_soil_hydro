...
sqrt(mean((swc_Hyytiala_calibration$obs - swc_Hyytiala_calibration$sum/200)^2))#0.057 new: 0.059
...
summary(lm(swc_Hyytiala_calibration$sum/h~swc_Hyytiala_calibration$obs)) #0.72 #new: 0.69
summary(lm(swc_Hyytiala_validation$sum/h~swc_Hyytiala_validation$obs)) #0.73
summary(lm(swc_Hyytiala_validation_interc$sum/h~swc_Hyytiala_validation_interc$obs)) #0.82
